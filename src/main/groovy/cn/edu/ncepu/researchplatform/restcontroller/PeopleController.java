...
public class PeopleController {
    ...
    public boolean 修改密码(String phone, String phoneCode, String newPass) {
        if (!otherService.verfyPhoneCode(phone, phoneCode) || !peopleService.findByUsername(Utils.getCurrent()).getPhone().equals(phone)) {
    ...
    public Integer 注册people(People people, HttpServletRequest request) {
        ...
        people.setPassword(customizerPasseordEncoder.encode(people.getPassword()));
    ...
    @PreAuthorize("#username==authentication.name or hasAuthority('admin')")
    public boolean 实名认证(@RequestBody Map<String, String> params, @PathVariable String username) {
